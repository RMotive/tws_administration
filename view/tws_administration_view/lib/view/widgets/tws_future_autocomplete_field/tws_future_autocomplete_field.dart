...
class _TWSAutoCompleteFieldState<TSet extends CSMEncodeInterface> extends State<TWSFutureAutoCompleteField<TSet>> with SingleTickerProviderStateMixin {
  ...
  late final Future<SetViewOut<TSet>> Function() consume;
                          ...
                          child: ConstrainedBox(
                              ...
                              child: ClipRRect(
                                  child: DecoratedBox(
                                      ...
                                      child: CSMConsumer<SetViewOut<TSet>>(
                                          consume: consume,
                                          emptyCheck: (SetViewOut<TSet> data) => data.sets.isEmpty,
                                          loadingBuilder: (_) {
                                            return Padding(
                                          ...
                                          errorBuilder: (BuildContext ctx, Object? error, SetViewOut<TSet>? data) {
                                          ...
                                          successBuilder: (BuildContext ctx, SetViewOut<TSet> data) {
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            "Not matches found",
                                                            style: TextStyle(overflow: TextOverflow.ellipsis, color: highContrastColor),
                                                          ),
                                                        ),
                                                      ],
                                                    ),
