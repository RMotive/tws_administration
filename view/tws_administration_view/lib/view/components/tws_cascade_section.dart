...
class TWSCascadeSection extends StatefulWidget {
  ...
  const TWSCascadeSection({super.key, this.onPressed, this.tooltip, this.padding = const EdgeInsets.symmetric(vertical: 10), required this.title, required this.mainControl, required this.content});
    ...
    return TWSSection(
        ...
        content: CSMSpacingColumn(
          ...
          children: <Widget>[
            ...
            Visibility(visible: show, child: widget.content)
          ],
        ));
  }
}
