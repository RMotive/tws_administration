part of 'accounts_create_whisper.dart';
          ...
          TextSpan(
            ...
            children: <InlineSpan>[
              ...
              for (int i = 0; i < failures.length; i++)
                TextSpan(
                  text: failures[i] is SetOperationFailure<Driver>? "${i + 1} - Driver with license number:  ${(failures[i] as SetOperationFailure<Driver>).set.driverCommonNavigation?.license}\n"
                  : failures[i] is SetOperationFailure<DriverExternal>? "${i + 1} - External Driver with license number:  ${(failures[i] as SetOperationFailure<DriverExternal>).set.driverCommonNavigation?.license}\n"
