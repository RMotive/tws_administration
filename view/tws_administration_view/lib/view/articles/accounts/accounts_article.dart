...
final class AccountsArticle extends PageB {
  ...
  Widget compose(BuildContext ctx, Size windowSize, Size pageSize) {
    return SecurityFrame(
      ...
      article: ReactiveWidget<_AccountArticleState>(
        reactor: _pageState,
        builder: (BuildContext ctx, _AccountArticleState state) {
            ...
            children: <Widget>[
              ...
              Expanded(
                child: TWSArticleTable<void>(
                  ...
                  fields: const <TWSArticleTableFieldOptions<void>>[
                  ],
                ),
              ),
            ],
