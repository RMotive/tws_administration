...
using View = CSM_Foundation.Source.Models.Out.SetViewOut<TWS_Business.Sets.TrailerExternal>;


namespace Server.Quality.Suit.Controllers;
public class Q_TrailersExternalsController : BQ_ServerController<Program> {
